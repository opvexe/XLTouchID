...
//
//  Created by TSM on 16/10/26.
//  Copyright © 2016年 TSM. All rights reserved.
//
...
/*
 根据当前语言国际化  -----> BulitSetting - >GUN89 设置语言
 */
+(NSString *)LanguageInternationalizationCH:(NSString *)Chinese EN:(NSString *)English
{
    return [[[[NSUserDefaults standardUserDefaults] objectForKey:@"AppleLanguages"] objectAtIndex:0] isEqualToString:@"zh-Hans-CN"] ? Chinese : English;
}
